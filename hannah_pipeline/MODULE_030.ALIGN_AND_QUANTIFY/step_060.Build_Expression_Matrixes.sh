...
Rscript /gpfs/Labs/Uzun/SCRIPTS/COMMON/RNA_SEQ/CURRENT/merge_read_counts.R $batch_read_count_dir/GENE_LEVEL  $batch_matrix_dir/Read_Count_Matrix.All_genes
ls -lh $batch_matrix_dir

Rscript /gpfs/Labs/Uzun/SCRIPTS/COMMON/RNA_SEQ/CURRENT/merge_read_counts.R $batch_read_count_dir/TRANSCRIPT_LEVEL  $batch_matrix_dir/Read_Count_Matrix.All_transcripts
ls -lh $batch_matrix_dir
